...
impl EagerPseudoCascadeInputs {
    /// Construct inputs from previous cascade results, if any.
    fn new_from_values(values: &EagerPseudoStyles) -> Self {
...
impl ElementCascadeInputs {
    ...
    pub fn new_from_element_data(data: &ElementData) -> Self {
        ...
        ElementCascadeInputs {
            primary: Some(CascadeInputs::new_from_values(data.styles.primary())),
            pseudos: EagerPseudoCascadeInputs::new_from_values(&data.styles.pseudos),
        }
    }
