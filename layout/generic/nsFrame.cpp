...
void
nsIFrame::List(nsACString& aTo, const char* aPrefix, uint32_t aFlags) const
{
...
void
nsIFrame::RootFrameList(nsPresContext* aPresContext, nsACString& aTo, const char* aPrefix)
{
  if (!aPresContext)
    return;
